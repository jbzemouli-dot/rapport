...
notamment des outils de calcul d'orbites et de traitement de mesures.
...
par les erreurs des mesures et des modèles. En général, la précision obtenue est généralement de l'ordre de
...
atteinte, la précision peut atteindre quelques centimètres. Cela nécesite de 
...
Aujourd'hui, Orekit est largement utilisée dans le secteur spatial et est activement 
maintenue par les développeurs de CS GROUP ainsi que par une communauté d'utilisateurs. 
...
Elle est notamment utilisée ou développée par des acteurs majeurs du secteur tels qu'Airbus 
...
et adaptées en fonction de l'application considérée. La bibliothèque couvre ainsi un 
