...
\begin{itemize}
    ...
    \item $\delta_{\mathrm{ant},r,\mathrm{IF}}^s=\alpha\delta_{\mathrm{ant},r,1}^s+\beta\delta_{\mathrm{ant},r,2}^s$ la correction de centre de phase du récepteur combinée ionosphère-libre ;
...
des satellites à des époques discrètes. À l'époque d'émission, le biais
interpolé est
...
Le format ANTEX fournit, pour chaque type d'antenne et chaque fréquence, les
...
ionosphère-libre sont détaillées en
