...
(NMF), proposé par Niell~\cite{niell1996}. Il permet ainsi de déterminer
...
depuis le 0 janvier de l'année considérée, exprimé en jours, et $T_0=28$
...
quant à eux, directement donnés par les valeurs tabulées.
...
\begin{figure}[H]
    ...
    \caption{Tableau des coefficients du modèle NMF pour la fonction hydrostatique.}
...
\begin{figure}[H]
    ...
    \caption{Tableau des coefficients du modèle NMF pour la fonction humide.}
...
ionosphérique diffusé dans le message de navigation GPS et permet de fournir une estimation
